...
public abstract class IRExperimentRunnerBase extends ExperimentRunner {
    public IRExperimentRunnerBase(System a_sua, Metric a_metric, boolean a_doUseManualMapping, RandomDoubleVariable a_initialSetSize, IRExperimentRunnerBase.Data a_irData) {
        super(a_sua, a_metric, a_doUseManualMapping, a_initialSetSize);

        m_data = new Data(a_irData);
    }

    public IRExperimentRunnerBase(Iterable<System> a_suas, Iterable<Metric> a_metrics, boolean a_doUseManualMapping, RandomDoubleVariable a_initialSetSize, Data a_irData) {
